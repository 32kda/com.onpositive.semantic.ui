...
public class IntegerOperator extends BinaryOperator<Number, Number>{

	public IntegerOperator(int kind){
	...
	//In comparison null is lower then any Number and is not equal to any number. Otherwise null is replaced by 0 ;	
