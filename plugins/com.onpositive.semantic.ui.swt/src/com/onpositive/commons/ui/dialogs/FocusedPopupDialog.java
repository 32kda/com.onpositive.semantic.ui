 ...
 * @since 3.2
 */
public class FocusedPopupDialog extends Window {
	 ...
	 */
	public FocusedPopupDialog(Shell parent, int shellStyle, boolean takeFocusOnOpen,
	 ...
	 * @since 3.4
	 */
	private FocusedPopupDialog(Shell parent, int shellStyle, boolean takeFocusOnOpen,
			boolean persistSize, boolean persistLocation,
			boolean showDialogMenu, boolean showPersistActions,
