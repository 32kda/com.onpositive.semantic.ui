...
public class DataModel {
	...
	private final HashMap<String, ValueClass> classes = new HashMap<String, ValueClass>();
	private final HashMap<String, DefaultModelProperty> properties = new HashMap<String, DefaultModelProperty>();
