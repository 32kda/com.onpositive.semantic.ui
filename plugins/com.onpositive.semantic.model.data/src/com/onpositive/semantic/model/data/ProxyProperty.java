...
public class ProxyProperty implements IProperty, IRealmProvider<Object>,
		IPropertyWithRealm<Object> {

	ICommandExecutor executor;
	IPropertyCalculator updater;
	IDataStoreRealm realm;
	...
	public <T> T getAdapter(Class<T> adapter) {
		...
		if (adapter == IMassPropertyProvider.class) {
	...
	public IPropertyProvider getPropertyProvider() {
		return (IPropertyProvider) this.realm.getPropertyProvider();
	}
