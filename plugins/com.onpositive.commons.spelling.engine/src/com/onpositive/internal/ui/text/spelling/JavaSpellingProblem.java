...
import com.onpositive.internal.ui.text.spelling.engine.ISpellEvent;
...
public class JavaSpellingProblem extends SpellingProblem {
	...
	public String getMessage() {
		 ...
		 return MessageFormat.format("Sentence should start from {0}", new
		 String[] { Character.toUpperCase(fSpellEvent.getWord().charAt(0))+fSpellEvent.getWord().substring(1) });
		
		 return MessageFormat.format("Unknown word -\"{0}\"", new
	...
	public ICompletionProposal[] getProposals(
		...
		boolean fixed = false;
		final boolean match = fSpellEvent.isMatch();
		final boolean sentence = fSpellEvent.isStart();
