...
public class PreferenceConstants {
	...
	public static final String SPELLING_PROPOSAL_THRESHOLD = "spelling_proposal_treshold";
	public static final String SPELLING_ENABLE_CONTENTASSIST = "spelling_enable_content_assist";
	...
	public static IPreferenceStore getPreferenceStore() {
		return Activator.getSpellingPreferenceStore();
	}
