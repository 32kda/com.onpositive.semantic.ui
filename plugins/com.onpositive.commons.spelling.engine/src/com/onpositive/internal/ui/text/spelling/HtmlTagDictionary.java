...
import com.onpositive.internal.ui.text.spelling.engine.AbstractSpellDictionary;
...
public class HtmlTagDictionary extends AbstractSpellDictionary {
	...
	/*
	 * @see
	 * org.eclipse.jdt.ui.text.spelling.engine.AbstractSpellDictionary#load(
	 * java.net.URL)
	 */
	protected synchronized boolean load(final URL url) {
		...
		for (int index = 0; index < IHtmlTagConstants.HTML_GENERAL_TAGS.length; index++) {
			...
			this.hashWord(IHtmlTagConstants.HTML_TAG_PREFIX
					+ IHtmlTagConstants.HTML_GENERAL_TAGS[index]
					+ IHtmlTagConstants.HTML_TAG_POSTFIX);
			this.hashWord(IHtmlTagConstants.HTML_CLOSE_PREFIX
					+ IHtmlTagConstants.HTML_GENERAL_TAGS[index]
					+ IHtmlTagConstants.HTML_TAG_POSTFIX);
		}
		return true;
	 ...
	 * @see
	 * com.onpositive.internal.ui.text.spelling.engine.AbstractSpellDictionary
	 * #stripNonLetters(java.lang.String)
	 * 
	 * @since 3.3
	 */
