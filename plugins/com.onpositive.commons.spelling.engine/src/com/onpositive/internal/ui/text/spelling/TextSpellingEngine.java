...
public class TextSpellingEngine extends SpellingEngine {
	...
	/*
	 * @see
	 * com.onpositive.internal.ui.text.spelling.SpellingEngine#check(org.eclipse
	 * .jface.text.IDocument, org.eclipse.jface.text.IRegion[],
	 * com.onpositive.internal.ui.text.spelling.engine.ISpellChecker,
	...
	protected void check(IDocument document, IRegion[] regions,
		...
		final SpellEventListener listener = new SpellEventListener(collector,
				document);
		for (int i = 0; i < regions.length; i++) {
			...
			checker.execute(listener, new SpellCheckIterator(document,
					regions[i], checker.getLocale()));
		}
	}
}
