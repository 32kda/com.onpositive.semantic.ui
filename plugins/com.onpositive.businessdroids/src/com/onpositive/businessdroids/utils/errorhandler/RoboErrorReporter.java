...
/**
 * Simple error reporting facility. Saves stacktraces and exception information
 * to external storage (if mounted and writable) Files are saved to folder
 * Android/data/your.package.name/files/stacktrace-dd-MM-YY.txt
 * 
