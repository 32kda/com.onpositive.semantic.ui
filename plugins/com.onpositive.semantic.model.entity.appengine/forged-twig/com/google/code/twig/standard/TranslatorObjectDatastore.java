...
import com.onpositive.semantic.model.entity.appengine.AppEngineExecutor;
...
//	 }
	...
	{
		assert instances != null;
		deleteKeys(Iterators.transform(instances, cachedInstanceToKeyFunction));
	}
	...
	private final Function<Object, Key> cachedInstanceToKeyFunction = new Function<Object, Key>()
	{
		...
		public Key apply(Object instance)
		{
			...
			if (key==null){
				...
				IKey key2 = GlobalAccess.getKey(instance);
				if (key2!=null){
					return AppEngineExecutor.getKey(configuration, key2);
				}
			}
			return key;
		}
	...
	private static final Function entityToKeyFunction = new EntityToKeyFunction();
}
