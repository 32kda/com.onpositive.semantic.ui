...
public abstract class NodeDocumentHandler extends DocumentHandler {
	 ...
	 * 
	 * @see
	 * org.eclipse.pde.internal.ui.model.plugin.DocumentHandler#getDocumentAttribute
	 ...
	 * 
	 * @see
	 * org.eclipse.pde.internal.ui.model.plugin.DocumentHandler#getDocumentNode
	 * (java.lang.String, org.eclipse.pde.internal.ui.model.IDocumentNode)
	 */
	protected IDocumentElementNode getDocumentNode(String name,
		...
		for (int i = 0; i < node.getChildNodes().length; i++) {
			final IDocumentElementNode child = node.getChildAt(i);
			child.setOffset(-1);
			child.setLength(-1);
		}
	 ...
	 * 
	 * @see
	 * org.eclipse.pde.internal.core.text.DocumentHandler#getDocumentTextNode()
	 */
	protected IDocumentTextNode getDocumentTextNode(String content,
		...
		if (textNode == null) {
			...
			final String newContent = textNode.getText() + content;
