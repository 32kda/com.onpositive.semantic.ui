...
public class GenericXMLWriter extends PrintWriter {
	...
	public void endTag(String name, boolean insertTab, boolean insertNewLine) {
		this.tab--;
		this.printTag('/' + name, null/* no parameters */, insertTab,
				insertNewLine, false/* don't close tag */);
	}
	...
	public void printTag(String name, HashMap parameters, boolean insertTab,
