...
public class OpenHandler extends AbstractActionElementHandler {
	...
	protected Action contribute(ActionsSetting parentContext, Context context,
		...
		final IContributionItem action = (IContributionItem) vl.createOpenContributionItem();
		String attribute = element.getAttribute("directEdit");
		String theme =element.getAttribute("theme");
		String role =element.getAttribute("role");
		String widget=element.getAttribute("widgetId");
		if (!vl.isAllowCellEditing()){
		vl.setOpenOnDoubleClick(true);
		}
