...
public class StructuredTextPartitionerForHTML extends StructuredTextPartitionerForXML implements IStructuredTextPartitioner {
	...
	private final static String[] configuredContentTypes = new String[]{IHTMLPartitions.HTML_DEFAULT, IHTMLPartitions.HTML_DECLARATION, IHTMLPartitions.HTML_COMMENT, IHTMLPartitions.SCRIPT, IHTMLPartitions.SCRIPT_EVENTHANDLER};
	...
	private static final String[] STYLE_ATTRIBUTE_NAMES =  {};
	...
	private String getScriptingPartitionType(IStructuredDocumentRegion coreNode) {
		...
		if (regions.size() > 4 && regions.get(1).getType() == DOMRegionContext.XML_TAG_NAME) {
			...
			if (potentialLanguageString.equalsIgnoreCase("script")) {
