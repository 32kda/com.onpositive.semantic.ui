					...
					if (i + 1 < length) {
						...
						if (inQuote) {
							...
							if (inCharGroup > 0 || inBraces > 0) {
								String msg= "Wrong delimiter position";
			...
			switch (ch) {
				...
				case 'c':
					if (i + 1 < length) {
						...
						String msg= "Error in escape sequence";
				...
				case 'x':
					if (i + 2 < length) {
						...
						try {
							...
							String msg= "Error in hex escape sequence";
							throw new PatternSyntaxException(msg, replaceText, i);
						}
				...
				case 'u':
					if (i + 4 < length) {
						...
						try {
							...
							String msg= "Error in unicode escape sequence";
							throw new PatternSyntaxException(msg, replaceText, i);
						}
						interpretRetainCase(buf, (char) parsedInt);
						i+= 4;
