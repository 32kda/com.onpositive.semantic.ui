...
<namespace description="" name="DataModel" url="http://www.jetface.org/datamodel">
    <element allowsChilds="propsetting" class="com.onpositive.datamodel.model.DataModelEvaluator" description="" extends="annotatedElement" name="property">
    ...
    <element allowsChilds="classsetting" class="com.onpositive.datamodel.model.DataModelEvaluator" description="" extends="annotatedElement" name="class">
    ...
    <element allowsChilds="annotatedElement" class="com.onpositive.datamodel.model.DataModelEvaluator" description="" extends="" name="model">
    ...
    <element allowsChilds="" class="com.onpositive.datamodel.model.DataModelEvaluator" description="" extends="classsetting" isAbstract="true" name="regexp-constraint">
        <property description="" name="pattern" required="true" type="regexp"/>
        <property description="" name="description" translatable="true" type="string"/>
    </element>
    <element allowsChilds="" class="com.onpositive.datamodel.model.DataModelEvaluator" description="" extends="classsetting" name="range-constraint">
        <property description="" name="description" translatable="true" type="string"/>
        <property description="" name="min" type="number"/>
        <property description="" name="max" type="number"/>
    </element>
    <element allowsChilds="" class="com.onpositive.datamodel.model.DataModelEvaluator" description="" extends="classsetting" name="realm-provider">
        <property description="" name="class" required="true" type="java"/>
    </element>
    <element allowsChilds="" class="com.onpositive.datamodel.model.DataModelEvaluator" description="" extends="property" name="calculatableProperty">
        <property description="" name="class" required="true" type="java"/>
    </element>
    <element allowsChilds="" class="com.onpositive.datamodel.model.DataModelEvaluator" description="" extends="classsetting" name="instanceListener">
        <property description="" name="class" required="true" type="java"/>
    </element>
    <element allowsChilds="" class="com.onpositive.datamodel.model.DataModelEvaluator" description="" extends="property" name="inverseProperty">
